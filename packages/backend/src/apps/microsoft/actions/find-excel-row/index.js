...
export default defineAction({
    name: 'Excel-Zeile finden',
    key: 'findExcelRow',
    description: 'Findet eine Zeile in einer Excel-Tabelle basierend auf einem Suchkriterium',
    arguments: [
        {
        ...
        },
        {
            ...
            type: 'string',
            required: true,
            description: 'Der Wert, nach dem in der ausgewählten Spalte gesucht werden soll',
            variables: true
        }
    ],
    ...
    async run($) {
        ...
        try {
            ...
            // Spalten der Tabelle abrufen um den Index der Suchspalte zu finden
            ...
            // Ein Objekt mit Spaltenname: Wert erstellen
            ...
            console.error('Fehler beim Suchen der Excel-Zeile:', error);
            throw error;
        }
    }
});
